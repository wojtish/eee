...
if (entry1.field("h") == 0 && entry1.field("wykluczone") != 1){
entry1.set("h",1)
...
else if (entry3 != null && entry3.field("h") == 0 && entry3.field("wykluczone") != 1){
entry3.set("h",1)
...
else if (entry16 != null && entry16.field("h") == 0 && entry16.field("wykluczone") != 1){
entry16.set('h',1)
