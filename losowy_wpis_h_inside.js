...
else if (entry2.field("h") == 0){
entry2.set('h',1)
entries.reverse()[1].show()
}
else if (entry3.field("h") == 0){
entry3.set("h",1)
entries.reverse()[2].show()
}
else if (entry4.field("h") == 0){
entry4.set("h",1)
entries.reverse()[3].show()
}
else if (entry5.field("h") == 0){
entry5.set('h',1)
entries.reverse()[4].show()
}

else if (entry6.field("h") == 0){
entry6.set('h',1)
entries.reverse()[5].show()
}

else if (entry7.field("h") == 0){
entry7.set('h',1)
entries.reverse()[6].show()
}
else if (entry8.field("h") == 0){
entry8.set('h',1)
entries.reverse()[7].show()
}
else if (entry9.field("h") == 0){
entry9.set('h',1)
entries.reverse()[8].show()
}

else if (entry10.field("h") == 0){
entry10.set('h',1)
entries.reverse()[9].show()
}

else if (entry11.field("h") == 0){
entry11.set('h',1)
...
else if (entry13.field("h") == 0){
entry13.set('h',1)
entries.reverse()[12].show()
}
else if (entry14.field("h") == 0){
entry14.set('h',1)
entries.reverse()[13].show()
}
else if (entry15.field("h") == 0){
entry15.set('h',1)
entries.reverse()[14].show()
}

else if (entry16.field("h") == 0){
entry16.set('h',1)
entries.reverse()[15].show()
}

else if (entry17.field("h") == 0){
entry17.set('h',1)
entries.reverse()[16].show()
}
else if (entry18.field("h") == 0){
entry18.set('h',1)
entries.reverse()[17].show()
}
else if (entry19.field("h") == 0){
entry19.set('h',1)
entries.reverse()[18].show()
}

else if (entry20.field("h") == 0){
entry20.set('h',1)
entries.reverse()[19].show()
}

else if (entry21.field("h") == 0){
entry21.set('h',1)
entries.reverse()[20].show()
}
else if (entry22.field("h") == 0){
entry22.set('h',1)
entries.reverse()[21].show()
}


else if (entry23.field("h") == 0){
entry23.set('h',1)
entries.reverse()[22].show()
}
else if (entry24.field("h") == 0){
entry24.set('h',1)
entries.reverse()[23].show()
}
else if (entry25.field("h") == 0){
entry25.set('h',1)
entries.reverse()[24].show()
}

else if (entry26.field("h") == 0){
entry26.set('h',1)
entries.reverse()[25].show()
}

else if (entry27.field("h") == 0){
entry27.set('h',1)
entries.reverse()[26].show()
}
else if (entry28.field("h") == 0){
entry28.set('h',1)
entries.reverse()[27].show()
}
else if (entry29.field("h") == 0){
entry29.set('h',1)
entries.reverse()[28].show()
}
else if (entry30.field("h") == 0){
entry30.set('h',1)
entries.reverse()[29].show()
}

else if (entry31.field("h") == 0){
entry31.set('h',1)
entries.reverse()[30].show()
}
else if (entry32.field("h") == 0){
entry32.set('h',1)
entries.reverse()[31].show()
}

else if (entry33.field("h") == 0){
entry33.set('h',1)
entries.reverse()[32].show()
}
else if (entry34.field("h") == 0){
entry34.set('h',1)
entries.reverse()[33].show()
}
else if (entry35.field("h") == 0){
entry35.set('h',1)
entries.reverse()[34].show()
}

else if (entry36.field("h") == 0){
entry36.set('h',1)
entries.reverse()[35].show()
}

else if (entry37.field("h") == 0){
entry37.set('h',1)
entries.reverse()[36].show()
}
else if (entry38.field("h") == 0){
entry38.set('h',1)
entries.reverse()[37].show()
}
else if (entry39.field("h") == 0){
entry39.set('h',1)
